...
#### [StatelessAuthenticationSuccessHandler](https://github.com/shiver-me-timbers/smt-spring-security-stateless/blob/master/src/main/java/shiver/me/timbers/security/spring/StatelessAuthenticationSuccessHandler.java)
...
secure [`TokenFactory`](https://github.com/shiver-me-timbers/smt-spring-security-stateless/blob/master/src/main/java/shiver/me/timbers/security/token/TokenFactory.java) the default factory doesn't
...
#### [StatelessAuthenticationFilter](https://github.com/shiver-me-timbers/smt-spring-security-stateless/blob/master/src/main/java/shiver/me/timbers/security/spring/StatelessAuthenticationFilter.java)
...
[`BasicJwtTokenFactory`](https://github.com/shiver-me-timbers/smt-spring-security-stateless/blob/master/src/main/java/shiver/me/timbers/security/token/BasicJwtTokenFactory.java) is a good example to
...
An [`AuthenticatedAuthentication`](https://github.com/shiver-me-timbers/smt-spring-security-stateless/blob/master/src/main/java/shiver/me/timbers/security/spring/AuthenticatedAuthentication.java)
is generated by default. This should actually be enough in most simple situations. If you are not going to need to
...
[`AuthenticationFactory`](https://github.com/shiver-me-timbers/smt-spring-security-stateless/blob/master/src/main/java/shiver/me/timbers/security/spring/AuthenticationFactory.java).
